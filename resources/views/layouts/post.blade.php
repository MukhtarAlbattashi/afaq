        ...
        <nav class="navbar navbar-expand-lg p-0 navbar-light">
            <div class="container">
                ...
                <div class="mx-3">
                    ...
                    <span class="fas fa-check text-main fs-5" data-fa-transform="shrink-10 up-.5" data-fa-mask="fas fa-certificate"></span>
                    <p class="text-mute">
                ...
                <div class="collapse navbar-collapse fw-bold justify-content-end" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link  {{ request()->routeIs('home') ? 'text-main' : '' }}" href="{{route('home')}}">الرئيسية</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link  {{ request()->routeIs('lessons') ? 'text-main' : '' }}" href="#">الدروس</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('posts') ? 'text-main' : '' }}" href="{{route('posts')}}">المقالات</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link  {{ request()->routeIs('programs') ? 'text-main' : '' }}" href="{{route('programs')}}">البرامج</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link  {{ request()->routeIs('about') ? 'text-main' : '' }}" href="{{route('about')}}">حول</a>
                        </li>
                    </ul>
                </div>
            </div>
