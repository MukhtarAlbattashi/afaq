...
<body>
    <div class="modal-body" dir="ltr">
        <h1>Privacy Policy for Play & Earn</h1>
        <p>At Play & Earn, accessible from https://mukhtaradsapp.ml/, one of our main priorities is the privacy of
            our visitors. This Privacy Policy document contains types of information that is collected and
            recorded by Play & Earn and how we use it.</p>
        <p>If you have additional questions or require more information about our Privacy Policy, do not
            hesitate to contact us.</p>
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
            with regards to the information that they shared and/or collect in Play & Earn. This policy is
        ...
        <h2>Log Files</h2>
        <p>Play & Earn follows a standard procedure of using log files. These files log visitors when they
        ...
        <p>Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to
            ...
            and content network Privacy Policy at the following URL – <a href="https://policies.google.com/technologies/ads">https://policies.google.com/technologies/ads</a>
        </p>
        <h2>Advertising Partners Privacy Policies</h2>
        <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Play & Earn.</p>
        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
            are used in their respective advertisements and links that appear on Play & Earn, which are sent
        ...
        <p>Note that Play & Earn has no access to or control over these cookies that are used by third-party
            advertisers.</p>
        <h2>Third Party Privacy Policies</h2>
        <p>Play & Earn's Privacy Policy does not apply to other advertisers or websites. Thus, we are
        ...
        <p>Play & Earn does not knowingly collect any Personal Identifiable Information from children under
